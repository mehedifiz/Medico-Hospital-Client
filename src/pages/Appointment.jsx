...
import RelatedDoctors from '../compnents/RelatedDoctors';
  ...
  return (
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4'>
        <div>
          {docInfo.image ? (
            <img className='bg-primary w-full sm:max-w-72 rounded-lg' src={docInfo.image} alt={docInfo.name || 'Doctor Image'} />
          ) : (
